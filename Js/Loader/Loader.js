...
function html(frame){
  ...
  setTimeout(function(){
    ...
    var currentPercent = 100; //Initial percentage
    ...
    }, 0.5); //We are using 10 cause it reference by a 1 second (1000 miliseconds) animation. If you're using 4 seconds, change to 40 as  example
  },100);
}
